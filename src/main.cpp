...
unsigned int nTargetSpacing = 1 * 60; // 60 secs
unsigned int nStakeMinAge = 60 * 60 * 24; // 24 hours
...
const string strMessageMagic = "darkmatter Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
  ...
  {
    nSubsidy = 6250000 * COIN;
  }
    else if(pindexBest->nHeight+1 >= 2 && pindexBest->nHeight+1 <= 25001)
  {
    nSubsidy = 5000 * COIN;
  }
...
// darkmatter: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "darkmatter", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Dark Matter";
        CTransaction txNew;
        txNew.nTime = 1505119429;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x3d26294009552206fd3d977261e3f40123ab21a6f997a53ec850a2a81fa6f4a9"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xd2, 0xb3, 0xf2, 0xd4 };
